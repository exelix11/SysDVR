...
namespace SysDVR.Client.Targets.RTSP
{
    class RtspServer : IDisposable
    {
        ...
        public class RTSPConnection : IDisposable
        {
            ...
            public uint ssrc = 0;                    // SSRC value used with this client connection
            ...
            public class SessionInfo
            {
                ...
                public UDPSocket udp_pair = null;     // Pair of UDP sockets (data and control) used when sending via UDP
