namespace UsbStreamGUI
{
	partial class MpvStreamControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.label2.Text = "To stream via mpv you must provide the path of it\'s .com executable, you can down" +
    "load it from the official site";
			...
			this.Size = new System.Drawing.Size(485, 77);
